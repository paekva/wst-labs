    ...
    private static void printBindingTemplates(BindingTemplates bindingTemplates) {
        ...
        for (BindingTemplate bindingTemplate : bindingTemplates.getBindingTemplate()) {
            ...
            if (bindingTemplate.getAccessPoint() != null) {
                System.out.println("Access Point: " + bindingTemplate.getAccessPoint().getValue() + " type "
                        + bindingTemplate.getAccessPoint().getUseType());
                if (bindingTemplate.getAccessPoint().getUseType() != null) {
                    if (bindingTemplate.getAccessPoint().getUseType()
                    ...
                    if (bindingTemplate.getAccessPoint().getUseType()
                        ...
                        System.out
                                .println("Use this access point value as a reference to another binding template.");
                    }
                    if (bindingTemplate.getAccessPoint().getUseType()
